<section class="content">
    ...
    <div class="box">
        ...
        <?php endif ?>
        <?php echo form_open('backend/products/store', "enctype=multipart/form-data"); ?>
        <div class="box-body">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" id="price" placeholder="Precio" required="required" class="form-control" value="<?php echo set_value('price') ? : ''; ?>">
                    </div>
                    <div class="form-group">
                        <label for="minimum_stock">Stock minimo</label>
                        <input type="text" name="minimum_stock" id="minimum_stock" placeholder="Stock minimo" required="required" class="form-control" value="<?php echo set_value('minimum_stock') ? : ''; ?>">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
