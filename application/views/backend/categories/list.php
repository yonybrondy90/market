        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="<?php echo base_url(); ?>backend/categories/add" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Categoria</a>
                </div>
            </div>
            <!-- /.row -->
                        ...
                        <tbody>
                            ...
                            <?php foreach ($categories as $category): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>backend/categories/edit/<?php echo $category->id; ?>" class="btn btn-warning btn-flat" title="Editar"><span class="glyphicon glyphicon-pencil"></span></a>
                                    </td>
                                </tr>
                                <?php $i++;?>
                            <?php endforeach;?>
