<section class="content">
    ...
    <div class="box">
        ...
        <?php endif ?>
        <?php echo form_open('backend/categories/update', "enctype=multipart/form-data"); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group <?php echo form_error('name') == true ? 'has-error' : '' ?>">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nombre de la categoria" required="required" value="<?php echo set_value('name')?:$category->name; ?>">
