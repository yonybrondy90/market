<section class="content">
    ...
    <div class="box">
        ...
        <?php endif ?>
        <?php echo form_open('backend/categories/store', "enctype=multipart/form-data"); ?>
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
        ...
        <div class="box-footer">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url(); ?>backend/categories" class="btn btn-danger"><i class="fa fa-arrow-left" aria-hidden="true"></i> Volver</a>
                </div>
            </div>
